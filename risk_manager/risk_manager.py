...
from utils.utils import Utils, print_exception
...
class RiskManager(IRiskManager):
    ...
    def __init__(self, events_queue: Queue, data_provider: DataProvider, portfolio: Portfolio, risk_properties: BaseRiskProps):
        ...
        self.risk_management_method = self._get_risk_management_methid(risk_properties)



    def _get_risk_management_method(self, risk_properties: BaseRiskProps) -> IRiskManager:
        """
        ...
        if isinstance(risk_properties, MaxLeverageFactorRiskProps):
            ...
            print_exception("ERROR: Método de Risk Mgmt desconocido: {risk_props}")
    ...
    def assess_order(self, sizing_event: SizingEvent) ->None:
        ...
        new_position_value = self._compute_value_of_position_in_account_currency(sizing_event.symbol, 
                                                                                sizing_event.volume, 
                                                                                position_type)
